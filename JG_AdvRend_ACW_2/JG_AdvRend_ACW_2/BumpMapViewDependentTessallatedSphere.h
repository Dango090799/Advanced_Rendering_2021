...
class BumpMapViewDependentTessallatedSphere
{
public: // Structors
	BumpMapViewDependentTessallatedSphere(const shared_ptr<DeviceResources>&);
public: // Accessors
...
public: // Functions
	...
	void SetDisplacementPowerCB(const float);
...
private: // Data
	...
	ComPtr<ID3D11Buffer> _displacementBuffer;
	...
	DisplacementPowerConstantBuffer _displacementBufferData;
